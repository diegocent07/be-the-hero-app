...
export default function Detail() {
	...
	const message = `Hola ${incident.name} desde hero app, me gustaría ayudar con el caso ${incident.title} con el valor de ${Intl.NumberFormat(
		'en-US',
	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.contactBox}>
				...
				<Text style={styles.heroTitle}>Sé el héroe de este caso.</Text>
